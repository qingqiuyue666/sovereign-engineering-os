"""Houdini adapter contract implementation."""
...
ADAPTER_NAME = "houdini"
DEFAULT_LEVEL = "LEVEL_1_DRY_RUN"

class HoudiniAdapter(AdapterContract):
    ...
    def dry_run(self, job: dict[str, object]) -> AdapterResult:
        return AdapterResult(
            ...
            "DRY_RUN_READY",
            dry_run=True,
            evidence=("hython_contract_ready",),
            metadata={"job": job, "staged_output_only": True},
        )

def build_adapter() -> HoudiniAdapter:
