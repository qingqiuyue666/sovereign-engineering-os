"""Flat read-only CI consumer for rendered batch readiness checks."""
...
_SURFACE = "task_lifecycle_journal_snapshot_batch_ci"
_VERSION = 1
_INPUT_SHAPE = "rendered_task_lifecycle_journal_snapshot_batch_readiness_check"
...
def task_lifecycle_journal_snapshot_batch_ci_manifest() -> dict[str, object]:
    """Return a defensive JSON-safe manifest for the CI consumer."""

    return deepcopy(_MANIFEST)


def consume_task_lifecycle_journal_snapshot_batch_ci(
    payload: object,
) -> dict[str, object]:
    """Flatten a rendered readiness check into a bounded CI result."""
