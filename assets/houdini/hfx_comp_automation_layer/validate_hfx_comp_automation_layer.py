"""Empty validator template for HFX Comp Automation Layer.
...
LAYER_DIRECTORY: Final[str] = "hfx_comp_automation_layer"
SCHEMA_FILENAMES: Final[tuple[str, ...]] = ("hfx_nuke_comp_template.schema.json", "hfx_resolve_comp_template.schema.json",)
