# HFX_033 Glow Emission Pass Promotion Closure
...
| code_version | 0.1.0 |
| content_hash | sha256:522626ebcf536caaacffe452c28fa562f2544401c9d40aa8440c5913d0882f26 |
| observed_at | not_provided |

## Current Evidence Summary
- checksum_evidence:
  - paths:
    - assets/houdini/hfx_factory_core12/500_HFX_FACTORY/HFX_033_BATCH_FINALIZE_V047_TO_V054/03_manifests/HFX_033_BATCH_FINALIZE_V047_TO_V054_SHA256SUMS.txt
  - present: true
  - summary: Checksum evidence is present in existing manifests; observed_at is not part of any content hash.
- hip_or_hda_evidence:
  - paths:
    - assets/houdini/hfx_factory_core12/300_PRODUCTION_UPGRADE/HFX_033_GLOW_EMISSION_PASS/03_final/hip/HFX_033_GLOW_EMISSION_PASS_FINAL_CANDIDATE_v054.hip
    - assets/houdini/hfx_factory_core12/300_PRODUCTION_UPGRADE/HFX_033_GLOW_EMISSION_PASS/10_release/release_package/hip/HFX_033_GLOW_EMISSION_PASS_FINAL_CANDIDATE_v054.hip
  - present: true
  - summary: Reusable internal HIP/HDA evidence is present; this branch does not mutate HIP/HDA files.
- manifest_evidence:
  - paths:
    - assets/houdini/hfx_factory_core12/500_HFX_FACTORY/HFX_033_BATCH_FINALIZE_V047_TO_V054/03_manifests/HFX_033_BATCH_FINALIZE_V047_TO_V054_MANIFEST.json
  - present: true
  - summary: Manifest evidence is present for the reusable internal asset closure.
- preview_evidence:
  - paths:
    - assets/houdini/hfx_factory_core12/00_INDEX_资产索引/HFX_033_BATCH_FINALIZE_REPORT.md
    - assets/houdini/hfx_factory_core12/300_PRODUCTION_UPGRADE/HFX_033_GLOW_EMISSION_PASS/01_preview/hip
  - present: true
...
- validation_evidence:
  - paths:
    - assets/houdini/hfx_factory_core12/00_INDEX_资产索引/HFX_033_BATCH_FINALIZE_REPORT.md
    - assets/houdini/hfx_factory_core12/500_HFX_FACTORY/HFX_033_BATCH_FINALIZE_V047_TO_V054/02_validation
  - present: true
...
- present: true
- route_id: HFX_033_rollback_route_v1
- safe_state: Audit-only closure state with no HIP/HDA mutation, no external raw asset enablement, and no generated media.
- trigger: HFX_033 evidence mismatch, unsafe claim, missing final proof, or manifest/checksum disagreement.
...
- present: true
- route_id: HFX_033_quarantine_route_v1
- safe_state: Audit-only closure state with no HIP/HDA mutation, no external raw asset enablement, and no generated media.
- trigger: HFX_033 evidence mismatch, unsafe claim, missing final proof, or manifest/checksum disagreement.
