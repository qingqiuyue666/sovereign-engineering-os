"""Empty validator template for HFX Review Dailies Layer.
...
LAYER_DIRECTORY: Final[str] = "hfx_review_dailies_layer"
SCHEMA_FILENAMES: Final[tuple[str, ...]] = ("hfx_dailies_manifest.schema.json", "hfx_qc_checklist.schema.json",)
