"""Empty validator template for HFX Final Pixel Gate Layer.
...
LAYER_DIRECTORY: Final[str] = "hfx_final_pixel_gate_layer"
SCHEMA_FILENAMES: Final[tuple[str, ...]] = ("hfx_blocked_claim_registry.schema.json",)
