"""
Twelve Asset Aov Validator

Generated validator template for hfx_aov_pass_contract_layer.
Purpose: Validate exactly twelve asset AOV profiles.
"""

SYSTEM_STATE = 'HFX_MASTER_PIPELINE_SYSTEM_READY_NO_FINAL_PIXELS'
LAYER_NAME = 'hfx_aov_pass_contract_layer'
VALIDATOR_NAME = 'twelve_asset_aov_validator'
