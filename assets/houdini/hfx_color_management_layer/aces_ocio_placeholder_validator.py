"""
Aces Ocio Placeholder Validator

Generated validator template for hfx_color_management_layer.
Purpose: Validate ACES/OCIO placeholder gates.
"""

SYSTEM_STATE = 'HFX_MASTER_PIPELINE_SYSTEM_READY_NO_FINAL_PIXELS'
LAYER_NAME = 'hfx_color_management_layer'
VALIDATOR_NAME = 'aces_ocio_placeholder_validator'
