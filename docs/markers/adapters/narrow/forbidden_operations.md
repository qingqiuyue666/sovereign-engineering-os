# Relocated Narrow Adapter Forbidden Operations Marker
...
- marker files under kernel/adapters/
- deleting existing adapter files
- moving existing adapter files
- modifying existing adapter files

These operations remain forbidden until a later explicit audit authorizes otherwise.

This file does not authorize any exception.

Existing adapter files remain classified separately as PRE_EXISTING_PHASE1_REAL_MODEL_IGNITION_ADAPTER_LANE.

That classification does not authorize new adapter implementation.
