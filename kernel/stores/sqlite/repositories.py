...
class AuditRepository:
    ...
    def list_capability_token_consume_rejected_for_task(
        self, task_id: str
    ) -> list[dict[str, Any]]:
        rows = self._conn.execute(
            """
    ...
    def list_capability_verification_rejected_for_task(
        self, task_id: str
    ) -> list[dict[str, Any]]:
        rows = self._conn.execute(
            """
            SELECT * FROM audit_records
             WHERE task_id = ?
               AND record_type = 'capability_verification_rejected'
             ORDER BY sequence;
            """,
            (task_id,),
        ).fetchall()
    ...
    def list_validation_quarantine_admission_rejected_for_task(
        self, task_id: str
    ) -> list[dict[str, Any]]:
        rows = self._conn.execute(
            """
    ...
    def list_review_self_summary_rejected_for_task(
        self, task_id: str
    ) -> list[dict[str, Any]]:
        rows = self._conn.execute(
            """
    ...
    def list_approval_barrier_rejected_for_task(
        self, task_id: str
    ) -> list[dict[str, Any]]:
        rows = self._conn.execute(
            """
    ...
    def list_approval_seal_time_barrier_rejected_for_task(
        self, task_id: str
    ) -> list[dict[str, Any]]:
        rows = self._conn.execute(
            """
    ...
    def list_approval_barrier_evaluation_error_for_task(
        self, task_id: str
    ) -> list[dict[str, Any]]:
        rows = self._conn.execute(
            """
    ...
    def list_validation_receipt_invalidated_for_task(
        self, task_id: str
    ) -> list[dict[str, Any]]:
        rows = self._conn.execute(
            """
    ...
    def list_approval_invalidated_for_task(
        self, task_id: str
    ) -> list[dict[str, Any]]:
        rows = self._conn.execute(
            """
