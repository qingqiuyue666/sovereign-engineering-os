...
class EvidenceProofHardeningBundleTests(unittest.TestCase):
    ...
    def test_makefile_health_runs_fixtures_then_final_runtime_then_provider_gate_before_schemas(self):
        ...
        self.assertLess(health_line.index("test-gated-provider-transport"), health_line.index("test-schemas"))
