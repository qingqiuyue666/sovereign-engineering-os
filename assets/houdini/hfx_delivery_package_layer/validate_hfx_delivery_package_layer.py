"""Empty validator template for HFX Delivery Package Layer.
...
LAYER_DIRECTORY: Final[str] = "hfx_delivery_package_layer"
SCHEMA_FILENAMES: Final[tuple[str, ...]] = ("hfx_delivery_manifest.schema.json",)
