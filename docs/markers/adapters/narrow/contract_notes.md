# Relocated Narrow Adapter Contract Notes Marker

This file points back to docs/contracts/narrow_adapter_contract_v1.md.

The contract remains authoritative for non-authority statements and forbidden operation rules.

If this marker conflicts with the contract, the stricter stop rule wins.

This file also depends on docs/design/narrow_adapter_skeleton_design_v1.md.

This file does not create contract implementation.

This file does not create adapter interface code.

This file does not create adapter skeleton code.

This file does not create runtime authority or execution capability.

This relocated marker path replaces the old kernel/adapters marker plan.
