"""After Effects adapter contract implementation."""
...
ADAPTER_NAME = "after_effects"
DEFAULT_LEVEL = "LEVEL_1_DRY_RUN"

class AfterEffectsAdapter(AdapterContract):
    ...
    def dry_run(self, job: dict[str, object]) -> AdapterResult:
        return AdapterResult(
            ...
            "DRY_RUN_READY",
            dry_run=True,
            evidence=("aerender_contract_ready",),
            metadata={"job": job, "staged_output_only": True},
        )

def build_adapter() -> AfterEffectsAdapter:
    return AfterEffectsAdapter()
