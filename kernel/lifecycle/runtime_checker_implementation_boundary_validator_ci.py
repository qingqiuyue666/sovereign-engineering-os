"""Read-only CI consumer for rendered runtime checker boundary output."""
...
_SURFACE = "runtime_checker_implementation_boundary_validator_ci"
_VERSION = 1
...
_PAYLOAD_KEYS = (
    "runtime_checker_implementation_boundary_ready",
    "reason_code",
    "failures",
    "boundary",
    "authority",
...
_CI_NON_AUTHORITY_SUMMARY = {
    "ci_ok_proves": (
        "already_rendered_runtime_checker_implementation_boundary_"
...
_EXPECTED_BOUNDARY = {
    ...
    "runtime_checker_implementation_boundary_model": {
        item: True for item in _RUNTIME_CHECKER_IMPLEMENTATION_BOUNDARY_MODEL
    },
    "checker_enforcer_separation_model": {
...
def runtime_checker_implementation_boundary_validator_ci_manifest():
    """Return bounded metadata for the read-only CI consumer."""

    return deepcopy(_MANIFEST)


def consume_runtime_checker_implementation_boundary_validator_ci(payload):
    ...
    readiness = payload.get("runtime_checker_implementation_boundary_ready")
