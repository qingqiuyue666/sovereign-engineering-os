...
Marker existence is not execution authorization.

Directory existence is not package authorization.

Markdown file existence is not runtime readiness.

Capability language is descriptive only.

Relocation does not create adapter readiness.

Relocation does not create execution capability.
