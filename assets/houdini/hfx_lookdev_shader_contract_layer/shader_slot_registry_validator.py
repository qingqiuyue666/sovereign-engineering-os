"""
Shader Slot Registry Validator

Generated validator template for hfx_lookdev_shader_contract_layer.
Purpose: Validate shader slot registry structure.
"""

SYSTEM_STATE = 'HFX_MASTER_PIPELINE_SYSTEM_READY_NO_FINAL_PIXELS'
LAYER_NAME = 'hfx_lookdev_shader_contract_layer'
VALIDATOR_NAME = 'shader_slot_registry_validator'
