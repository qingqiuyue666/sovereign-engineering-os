"""Empty validator template for HFX Color Management Layer.
...
LAYER_DIRECTORY: Final[str] = "hfx_color_management_layer"
SCHEMA_FILENAMES: Final[tuple[str, ...]] = ("hfx_ocio_contract.schema.json", "hfx_aces_contract.schema.json",)
