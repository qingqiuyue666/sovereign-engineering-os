.PHONY: ci test-root-integrity test-sealed-evidence-coverage test-evidence-proof-contract test-schemas test-tracer-bullet test-acceptance diff-check health
