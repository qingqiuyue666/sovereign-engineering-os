"""Empty validator template for HFX Plate Camera Integration Layer.
...
LAYER_DIRECTORY: Final[str] = "hfx_plate_camera_integration_layer"
SCHEMA_FILENAMES: Final[tuple[str, ...]] = ("hfx_tracking_contract.schema.json", "hfx_lens_metadata.schema.json",)
