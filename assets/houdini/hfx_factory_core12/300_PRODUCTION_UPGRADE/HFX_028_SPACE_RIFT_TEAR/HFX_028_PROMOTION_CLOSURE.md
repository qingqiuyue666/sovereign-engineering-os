# HFX_028 Space Rift Tear Promotion Closure
...
| code_version | 0.1.0 |
| content_hash | sha256:46663f79f7ee30ad5a941268079f5b65dcf2d8d68026b712af7336786002a079 |
| observed_at | not_provided |

## Current Evidence Summary
- checksum_evidence:
  - paths:
    - assets/houdini/hfx_factory_core12/500_HFX_FACTORY/HFX_028_BATCH_FINALIZE_V039_TO_V046/03_manifests/HFX_028_BATCH_FINALIZE_V039_TO_V046_SHA256SUMS.txt
  - present: true
  - summary: Checksum evidence is present in existing manifests; observed_at is not part of any content hash.
- hip_or_hda_evidence:
  - paths:
    - assets/houdini/hfx_factory_core12/300_PRODUCTION_UPGRADE/HFX_028_SPACE_RIFT_TEAR/03_final/hip/HFX_028_SPACE_RIFT_TEAR_FINAL_CANDIDATE_v046.hip
    - assets/houdini/hfx_factory_core12/300_PRODUCTION_UPGRADE/HFX_028_SPACE_RIFT_TEAR/10_release/release_package/hip/HFX_028_SPACE_RIFT_TEAR_FINAL_CANDIDATE_v046.hip
  - present: true
  - summary: Reusable internal HIP/HDA evidence is present; this branch does not mutate HIP/HDA files.
- manifest_evidence:
  - paths:
    - assets/houdini/hfx_factory_core12/500_HFX_FACTORY/HFX_028_BATCH_FINALIZE_V039_TO_V046/03_manifests/HFX_028_BATCH_FINALIZE_V039_TO_V046_MANIFEST.json
  - present: true
  - summary: Manifest evidence is present for the reusable internal asset closure.
- preview_evidence:
  - paths:
    - assets/houdini/hfx_factory_core12/00_INDEX_资产索引/HFX_028_BATCH_FINALIZE_REPORT.md
    - assets/houdini/hfx_factory_core12/300_PRODUCTION_UPGRADE/HFX_028_SPACE_RIFT_TEAR/01_preview/hip
  - present: true
...
- validation_evidence:
  - paths:
    - assets/houdini/hfx_factory_core12/00_INDEX_资产索引/HFX_028_BATCH_FINALIZE_REPORT.md
    - assets/houdini/hfx_factory_core12/500_HFX_FACTORY/HFX_028_BATCH_FINALIZE_V039_TO_V046/02_validation
  - present: true
...
- present: true
- route_id: HFX_028_rollback_route_v1
- safe_state: Audit-only closure state with no HIP/HDA mutation, no external raw asset enablement, and no generated media.
- trigger: HFX_028 evidence mismatch, unsafe claim, missing final proof, or manifest/checksum disagreement.
...
- present: true
- route_id: HFX_028_quarantine_route_v1
- safe_state: Audit-only closure state with no HIP/HDA mutation, no external raw asset enablement, and no generated media.
- trigger: HFX_028 evidence mismatch, unsafe claim, missing final proof, or manifest/checksum disagreement.
