"""
Parameter Interface Validator

Generated validator template for hfx_assetization_layer.
Purpose: Validate HDA public parameter interface declarations.
"""

SYSTEM_STATE = 'HFX_MASTER_PIPELINE_SYSTEM_READY_NO_FINAL_PIXELS'
LAYER_NAME = 'hfx_assetization_layer'
VALIDATOR_NAME = 'parameter_interface_validator'
