"""Repaired semantic implementation for deterministic dry-run orchestration.

This module is imported by dry_run_orchestrator.py.  It proves boundary
refusal paths instead of accepting already-disabled descriptors, and it uses
the existing failure_bundle and replay_plan modules on rejection paths.
"""
