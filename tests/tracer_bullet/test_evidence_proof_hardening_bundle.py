...
class EvidenceProofHardeningBundleTests(unittest.TestCase):
    ...
    def test_makefile_health_runs_fixtures_then_runtime_gates_before_schemas(self):
        ...
        self.assertLess(health_line.index("test-protected-evidence-storage"), health_line.index("test-real-hmac-policy-realization"))
        self.assertLess(health_line.index("test-real-hmac-policy-realization"), health_line.index("test-schemas"))
