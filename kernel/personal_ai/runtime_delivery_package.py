...
_KNOWN_RUNTIME_ARTIFACTS = (
    ...
    ("model_provider_result_manifest", "model_provider_result_manifest.json"),
    ("model_provider_dry_run_plan", "model_provider_dry_run_plan.json"),
    ("model_provider_failure_quarantine", "model_provider_failure_quarantine.json"),
    ("browser_action_log", "browser_action_log.json"),
    ("browser_evidence_manifest", "browser_evidence_manifest.json"),
    ("browser_runtime_result_manifest", "browser_runtime_result_manifest.json"),
    ("browser_runtime_dry_run_plan", "browser_runtime_dry_run_plan.json"),
    ("browser_runtime_failure_quarantine", "browser_runtime_failure_quarantine.json"),
    ...
    ("comfyui_runtime_result_manifest", "comfyui_runtime_result_manifest.json"),
    ("comfyui_endpoint_dry_run_plan", "comfyui_endpoint_dry_run_plan.json"),
    ("comfyui_runtime_failure_quarantine", "comfyui_runtime_failure_quarantine.json"),
    ...
    ("blender_runtime_result_manifest", "blender_runtime_result_manifest.json"),
    ("blender_runtime_dry_run_plan", "blender_runtime_dry_run_plan.json"),
    ("blender_runtime_failure_quarantine", "blender_runtime_failure_quarantine.json"),
    ("creative_handoff_manifest", "creative_handoff_manifest.json"),
    ("creative_handoff_tool_manifest", "creative_handoff_tool_manifest.json"),
    ("creative_handoff_instructions", "creative_handoff_instructions.md"),
...
_ARTIFACT_POLICIES = {
    ...
    "model_provider_result_manifest": ("metadata_only", "medium"),
    "model_provider_dry_run_plan": ("metadata_only", "medium"),
    "model_provider_failure_quarantine": ("metadata_only", "medium"),
    "browser_action_log": ("metadata_only", "medium"),
    "browser_evidence_manifest": ("metadata_only", "medium"),
    "browser_runtime_result_manifest": ("metadata_only", "medium"),
    "browser_runtime_dry_run_plan": ("metadata_only", "medium"),
    "browser_runtime_failure_quarantine": ("metadata_only", "medium"),
    ...
    "comfyui_runtime_result_manifest": ("metadata_only", "medium"),
    "comfyui_endpoint_dry_run_plan": ("metadata_only", "medium"),
    "comfyui_runtime_failure_quarantine": ("metadata_only", "medium"),
    ...
    "blender_runtime_result_manifest": ("metadata_only", "medium"),
    "blender_runtime_dry_run_plan": ("metadata_only", "medium"),
    "blender_runtime_failure_quarantine": ("metadata_only", "medium"),
    "creative_handoff_manifest": ("metadata_only", "medium"),
    "creative_handoff_tool_manifest": ("metadata_only", "medium"),
    "creative_handoff_instructions": ("metadata_only", "medium"),
