"""
Plate Camera Lens Hdri Binding Validator

Generated validator template for hfx_plate_camera_integration_layer.
Purpose: Validate shot plate, camera, lens, and HDRI bindings.
"""

SYSTEM_STATE = 'HFX_MASTER_PIPELINE_SYSTEM_READY_NO_FINAL_PIXELS'
LAYER_NAME = 'hfx_plate_camera_integration_layer'
VALIDATOR_NAME = 'plate_camera_lens_hdri_binding_validator'
