# Relocated Narrow Adapter Future Gate Marker

A future adapter skeleton implementation package remains blocked unless a later explicit audit authorizes it.
...
- whether any file under kernel/adapters/ is authorized
- whether existing adapter files may be changed

Current answer for all implementation surfaces:

Not authorized by this marker package.

Current answer for files under kernel/adapters/:
