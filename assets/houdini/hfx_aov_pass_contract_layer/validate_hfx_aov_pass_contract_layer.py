"""Empty validator template for HFX AOV Pass Contract Layer.
...
LAYER_DIRECTORY: Final[str] = "hfx_aov_pass_contract_layer"
SCHEMA_FILENAMES: Final[tuple[str, ...]] = ("hfx_global_aov_matrix.schema.json",)
